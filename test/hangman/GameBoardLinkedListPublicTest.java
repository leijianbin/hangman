...
public class GameBoardLinkedListPublicTest {

	private GameBoardLinkedList board1;
	private GameBoardLinkedList board2;
	
	@Before
	public void before() {
		board1 = new GameBoardLinkedList("Zigzag");
		board2 = new GameBoardLinkedList("Volume");
	}
	...
	public void testPreviousGuessString() {		
		...
		assertTrue("Previous gess string should be \"[v, d, c, x, q, r, l, m, n]\"",
